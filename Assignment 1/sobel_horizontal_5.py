...
path = '/Users/marco/Documents/KU Leuven/Computer Vision/Assignment 1/Generated Clips/clip7_sobel_horizontal_5.mp4'
...
while True:
    ...
    cv2.putText(frame, text='Sobel horizontal edge detection, ksize=5', org=(20, 60), fontFace=font, fontScale=2, color=(255, 255, 255),
