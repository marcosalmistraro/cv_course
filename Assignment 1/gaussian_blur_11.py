...
path = '/Users/marco/Documents/KU Leuven/Computer Vision/Assignment 1/Generated Clips/clip1_gaussian_11.mp4'
...
while True:
    ...
    blurred = cv2.GaussianBlur(frame, (51,51), sigmaX=0)
    cv2.putText(blurred, text='Gaussian blurring, ksize=11', org=(20, 60), fontFace=font, fontScale=2, color=(255, 255, 255),
    ...
    cv2.imshow('gaussian blur 11', blurred)
