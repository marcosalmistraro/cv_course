...
path = '/Users/marco/Documents/KU Leuven/Computer Vision/Assignment 1/Generated Clips/clip7_colored.mp4'
...
while True:
    ...
    cv2.putText(frame, text='Full color image', org=(20, 60), fontFace=font, fontScale=2, color=(255, 255, 255),
