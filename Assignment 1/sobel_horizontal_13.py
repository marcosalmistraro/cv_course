...
def apply_sobel_y(img):
    sobel_y = cv2.Sobel(img, ddepth=cv2.CV_64F, dx=0, dy=1, ksize=13)
...
path = '/Users/marco/Documents/KU Leuven/Computer Vision/Assignment 1/Generated Clips/clip7_sobel_horizontal_13.mp4'
...
while True:
    ...
    cv2.putText(frame, text='Sobel horizontal edge detection, ksize=13', org=(20, 60), fontFace=font, fontScale=2, color=(255, 255, 255),
